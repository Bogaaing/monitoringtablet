...
export function IllustrationSection() {
  return (
    <div className="hidden lg:flex flex-1 bg-gradient-to-br from-slate-50 via-indigo-50/20 to-slate-100 relative bg-[radial-gradient(#cbd5e1_1.2px,transparent_1.2px)] [background-size:24px_24px] overflow-hidden flex-col justify-between p-10 select-none">
      
      {/* Ambient Circular Overlay Lines */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-40">
        <div className="w-[580px] h-[580px] border border-slate-300/60 rounded-full" />
        <div className="absolute w-[780px] h-[780px] border border-slate-200/50 rounded-full" />
      </div>
      ...
      <div className="relative w-full h-full min-h-[500px] flex items-center justify-center">
        ...
        <div className="absolute top-[6%] left-[6%] z-30 animate-bounce" style={{ animationDuration: '6s' }}>
        ...
        <div
          className="absolute top-[2%] right-[6%] z-30 animate-bounce"
          style={{ animationDuration: '7s', animationDelay: '1s' }}
        >
          <div className="bg-white/95 backdrop-blur-md border border-white/80 rounded-2xl p-4 min-w-[210px] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.08)]">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
          <div className="[transform:rotateX(54deg)_rotateZ(-32deg)] w-[460px] h-[340px] bg-slate-200/50 rounded-[44px] shadow-[-30px_40px_60px_rgba(0,0,0,0.06)] flex items-center justify-center">
            <div className="w-full h-full bg-gradient-to-tr from-slate-100 via-white to-slate-50 rounded-[40px] border-4 border-white/80 p-4" />
          </div>
        </div>

        {/* Center Mockup Group: STRAIGHT FRONT-FACING TABLET + 3D QR TILE */}
        <div className="relative z-20 flex items-center justify-center my-auto">
          
          {/* Straight Front-Facing Tablet Device (Lurus / 0° Tilt) */}
          <div className="w-[430px] bg-slate-900 rounded-[28px] p-3 shadow-[-15px_25px_60px_rgba(15,23,42,0.25),0_0_2px_rgba(0,0,0,0.4)] border-4 border-slate-800/90 relative">
            {/* Camera Dot Top Center */}
            <div className="w-2 h-2 bg-slate-700 rounded-full mx-auto mb-2" />

            {/* Tablet Display Screen */}
            <div className="w-full bg-slate-50 rounded-[20px] overflow-hidden flex flex-col text-[10px] text-slate-700 select-none shadow-inner">
          ...
          <div className="[transform:rotateX(54deg)_rotateZ(-32deg)] absolute right-[10%] bottom-[18%] w-20 h-20 bg-white rounded-2xl p-2 shadow-[-10px_15px_30px_rgba(0,0,0,0.14)] flex items-center justify-center border border-slate-100 z-20">
        ...
        <div
          className="absolute bottom-[3%] z-30 animate-bounce"
          style={{ animationDuration: '8s', animationDelay: '2s' }}
        >
          <div className="bg-white/95 backdrop-blur-md border border-white/80 rounded-2xl px-5 py-3.5 flex items-center gap-4 min-w-[340px] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.08)]">
      ...
      {/* BOTTOM FEATURE HIGHLIGHTS GRID (4 Feature Cards) */}
      <div className="grid grid-cols-4 gap-4 mt-auto pt-6 border-t border-slate-100/60">
        ...
        <div className="flex flex-col items-center text-center group cursor-pointer">
          <div className="w-12 h-12 rounded-2xl bg-indigo-50/80 border border-indigo-100 text-indigo-600 flex items-center justify-center mb-2.5 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm">
            <Shield className="w-6 h-6 stroke-current fill-none transition-colors" />
          </div>
        ...
        <div className="flex flex-col items-center text-center group cursor-pointer">
          <div className="w-12 h-12 rounded-2xl bg-indigo-50/80 border border-indigo-100 text-indigo-600 flex items-center justify-center mb-2.5 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm">
            <Activity className="w-6 h-6 stroke-current fill-none transition-colors" />
          </div>
        ...
        <div className="flex flex-col items-center text-center group cursor-pointer">
          <div className="w-12 h-12 rounded-2xl bg-indigo-50/80 border border-indigo-100 text-indigo-600 flex items-center justify-center mb-2.5 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm">
            <MapPin className="w-6 h-6 stroke-current fill-none transition-colors" />
          </div>
        ...
        <div className="flex flex-col items-center text-center group cursor-pointer">
          <div className="w-12 h-12 rounded-2xl bg-indigo-50/80 border border-indigo-100 text-indigo-600 flex items-center justify-center mb-2.5 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm">
            <UserCheck className="w-6 h-6 stroke-current fill-none transition-colors" />
          </div>
